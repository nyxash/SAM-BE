...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2024 at 11:28 PM
...
(7, 3, 'travel1.jpg', 'The beaches of Batangas are magical. The clear waters and soft sand make it the perfect place to relax. Watching the sunsets here takes my breath away. It’s my go-to destination for unwinding and enjoying nature. The peaceful atmosphere makes me feel at home.', '#655C9E'),
(8, 3, 'travel2.jpeg', 'Liliw is my escape from the busy world. The cool weather and calm vibe create the perfect atmosphere for peace. Whether I’m exploring or just sitting back to relax, Liliw offers a sense of tranquility that I can’t find anywhere else. It’s where I go to clear my mind.', '#655C9E'),
(9, 3, 'travel3.JPG', 'Baguio holds a special place in my heart. The cool mountain air and scenic beauty make it unforgettable. The view from the mountains reminds me of how beautiful the Philippines is. Baguio is a place I always return to. It’s a reminder that there’s so much more to explore in our country.', '#655C9E'),
...
(3, 'Travel', 'Exploring new places, one step at a time.', 'This island holds the memories of all the places I’ve visited. Each destination offers something unique and special. Whether it’s the excitement of discovering a new place or the peace of nature, every journey helps me grow.', '#655C9E', 'travel.jpeg', 'Active'),
